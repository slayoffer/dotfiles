...
plugins=(dotenv zsh-history-substring-search zsh-syntax-highlighting git zsh-autosuggestions docker docker-compose aliases kubectl helm)
...
# if [ -f '/home/slayo/yandex-cloud/path.bash.inc' ]; then source '/home/slayo/yandex-cloud/path.bash.inc'; fi
